                    ...
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                         ...
                         <div class="form-group row">
                            ...
                            <select class="form-control" id="seeAnotherFieldGroup" name="role_id">
                                  <option value="2" >User</option>
                                  <option value="1" id="">Provider</option>
                            </select>
                          </div>
                          ...
                          <div class="form-group" id="otherFieldGroupDiv">
                            <div class="row">
                              <div class="col-6">
                                <label for="otherField2">Profession / Business Name</label>
                                <input type="text" name="business" class="form-control w-100" id="otherField2">
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="city" type="text" class="form-control @error('name') is-invalid @enderror" name="city" value="{{ old('name') }}"
                                 required autocomplete="city" placeholder="City Name" autofocus>
                                @error('city')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control @error('email') is-invalid @enderror" name="phonNo" value="{{ old('phonNo') }}" required autocomplete="email" placeholder="Phone Number">
